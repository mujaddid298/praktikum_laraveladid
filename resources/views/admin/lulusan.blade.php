...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active"aria-current="page" href="{{ route('admin.lulusan') }}">Profile Lulusan</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row mt-5">
        ...
        <div class="col"></div>
        <div class="col-2">
            <a class="btn btn-success" href="{{ route('admin.inda') }}"
        ...
        <tbody class="table-group-divider">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-outline-danger" href="/admin/deleteLulusan/{{ $lulusan->id }}">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
