...
<body>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{ route('admin.berita') }}">Berita</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row mt-5">
        ...
        <div class="col"></div>
        <div class="col-2">
            <a class="btn btn-success" href="{{ route('admin.inber') }}"
        ...
        <tbody class="table-group-divider">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-outline-danger" href="/admin/deleteBerita/{{ $berita->id }}">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
